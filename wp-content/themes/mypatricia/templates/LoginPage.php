...
<head>
	...
	<link href="<?php bloginfo("template_directory")?>/assets/login/css/ForgotPassword.routes.460db958.css"
		rel="stylesheet">
	...
	<link href="<?php bloginfo("template_directory")?>/assets/login/css/PerfectMoney.routes.d2485cd8.css"
		rel="stylesheet">
	<link href="<?php bloginfo("template_directory")?>/assets/login/css/Rates.routes.129c1632.css" rel="stylesheet">
	<link href="<?php bloginfo("template_directory")?>/assets/login/css/RegisterBank.routes.6c43b400.css"
		rel="stylesheet">
	<link href="<?php bloginfo("template_directory")?>/assets/login/css/RegisterEmail.routes.7076c324.css"
		rel="stylesheet">
	<link href="<?php bloginfo("template_directory")?>/assets/login/css/RegisterName.routes.0943841c.css"
		rel="stylesheet">
	<link href="<?php bloginfo("template_directory")?>/assets/login/css/RegisterPassword.routes.1aaf4e94.css"
		rel="stylesheet">
	<link href="<?php bloginfo("template_directory")?>/assets/login/css/RegisterPhone.routes.77a307f6.css"
		rel="stylesheet">
	<link href="<?php bloginfo("template_directory")?>/assets/login/css/Settings.routes.84734b0f.css" rel="stylesheet">
	<link href="<?php bloginfo("template_directory")?>/assets/login/css/TradeGiftcards.routes.a4d91881.css"
		rel="stylesheet">
	<link href="<?php bloginfo("template_directory")?>/assets/login/css/VerifyPhone.routes.446cacb2.css" rel="stylesheet">
	<link href="<?php bloginfo("template_directory")?>/assets/login/css/authverify2faCode.routes.836c113c.css"
		rel="stylesheet">
	...
	<link href="<?php bloginfo("template_directory")?>/assets/login/css/depositRedirect.routes.73bfbfb3.css"
		rel="stylesheet">
	<link href="<?php bloginfo("template_directory")?>/assets/login/css/notifications.routes.d152fad5.css"
		rel="stylesheet">
	<link href="<?php bloginfo("template_directory")?>/assets/login/css/products.routes.6c6246e0.css" rel="stylesheet">
	<link href="<?php bloginfo("template_directory")?>/assets/login/css/resetPassword.routes.ccd58f4a.css"
		rel="stylesheet">
	<link href="<?php bloginfo("template_directory")?>/assets/login/css/transactions.routes.9592f42c.css"
		rel="stylesheet">
	<link href="<?php bloginfo("template_directory")?>/assets/login/css/verifyregistrationemail.routes.4bf59011.css"
		rel="stylesheet">
	...
	<link href="<?php bloginfo("template_directory")?>/assets/login/js/ForgotPassword.routes.c685a271.js"
		rel="stylesheet">
	...
	<link href="<?php bloginfo("template_directory")?>/assets/login/js/RegisterPassword.routes.3d9b676a.js"
		rel="stylesheet">
	<link href="<?php bloginfo("template_directory")?>/assets/login/js/RegisterPhone.routes.660185d2.js" rel="stylesheet">
	<link
		href="<?php bloginfo("template_directory")?>/assets/login/js/RegisterPhone.routes~VerifyPhone.routes.63ddb43c.js"
		rel=prefetch>
	<link href="<?php bloginfo("template_directory")?>/assets/login/js/Settings.routes.7b3cf61c.js" rel="stylesheet">
	<link href="<?php bloginfo("template_directory")?>/assets/login/js/TradeGiftcards.routes.54a35fb9.js"
		rel="stylesheet">
	<link href="
		<?php bloginfo("template_directory")?>/assets/login/js/TradeGiftcards.routes~VerifyPhone.routes.6c64a8ea.js"
		rel=prefetch>
	<link href="<?php bloginfo("template_directory")?>/assets/login/js/VerifyPhone.routes.e4d5b499.js" rel="stylesheet">
	<link href="<?php bloginfo("template_directory")?>/assets/login/js/authverify2faCode.routes.27ddfcf7.js"
		rel="stylesheet">
	...
	<link href="<?php bloginfo("template_directory")?>/assets/login/js/depositRedirect.routes.f4814ba4.js"
		rel="stylesheet">
	...
	<link href="<?php bloginfo("template_directory")?>/assets/login/js/vendors~Giftcards.routes.6bf28c01.js"
		rel="stylesheet">
	<link href="<?php bloginfo("template_directory")?>/assets/login/js/vendors~Home.routes.98cef7c2.js" rel="stylesheet">
	<link href="
		<?php bloginfo("template_directory")?>/assets/login/js/vendors~RegisterBank.routes~RegisterEmail.routes.da08caf6.js"
		rel=prefetch>
	<link
		href="
		<?php bloginfo("template_directory")?>/assets/login/js/vendors~VerifyPhone.routes~verifyregistrationemail.routes.53a9e127.js"
		rel=prefetch>
	<link href="<?php bloginfo("template_directory")?>/assets/login/js/vendors~wallet.routes.c92e45e6.js"
		rel="stylesheet">
	<link href="<?php bloginfo("template_directory")?>/assets/login/js/verifyregistrationemail.routes.84cb556a.js"
		rel=prefetch>
	...
	<link href="<?php bloginfo("template_directory")?>/assets/login/css/app.cdff32df.css" rel=preload as=style>
	<link href="<?php bloginfo("template_directory")?>/assets/login/css/vendors~app.5a791a0c.css" rel=preload as=style>
...
<body class=" pace-done">
	...
	</div><noscript><strong>We're sorry but patricia-new-web doesn't work properly without JavaScript enabled. Please
	...
	<div data-v-3394a188="" id="app">
		<div data-v-3394a188="" class="page-container loader-normal">
			...
			<!---->
			<div data-v-378b7697="" data-v-3394a188="" class="container-fluid">
				<div data-v-378b7697="" class="row">
					<div data-v-378b7697="" class="col-md-6 image-con visible-md visible-lg text-white"><img data-v-378b7697=""
							src="https://storage.googleapis.com/patricia-website-assets/signin_page_image.svg" alt=""
							class="img-responsive">
						<div data-v-378b7697="" class="image-con-text text-primary">
							<h1 data-v-378b7697="">
								We are simply <b data-v-378b7697="">BUILT</b> for you
							</h1>
						</div>
					</div>
					<div data-v-378b7697="" class="col-md-6 row text-center">
						<div data-v-378b7697=""
							class="auth text-center col-lg-6 col-lg-offset-3 col-md-8 col-md-offset-2 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
							<div data-v-378b7697="" class="row">
								<div data-v-378b7697="" class="col-xs-10 col-xs-offset-1">
									<h3 data-v-378b7697="" class="text-primary text-bold">Hey Chief! We missed You.</h3>
									<p data-v-378b7697="" class="text-grey2">
										Please login below

									</p><br data-v-378b7697="">
									<form data-v-378b7697="">
										<div data-v-2187cb80="" data-v-378b7697="" class="form-sm inner-addon left-addon"><img
												data-v-2187cb80=""
												src="<?php bloginfo("template_directory")?>/assets/login/img/username.ae1d50b3.svg"
												class="glyphicon"><input data-v-2187cb80="" type="text" placeholder="Username"
												required="required" name="username" class="form-control"></div><br data-v-378b7697="">
										<div data-v-2187cb80="" data-v-378b7697="" class="form-sm inner-addon left-addon"><img
												data-v-2187cb80=""
												src="<?php bloginfo("template_directory")?>/assets/login/img/password.3d6f168f.svg"
												class="glyphicon"><input data-v-2187cb80="" type="password" placeholder="Password"
												required="required" name="password" class="form-control cc_cursor"></div>
										<!----><a data-v-378b7697="" href="/forgotpassword" class="text-grey-400 pull-left pt-10 co">Forgot
											Password?</a><br data-v-378b7697=""><br data-v-378b7697="">
										<div data-v-2474a4b0="" data-v-378b7697=""><button data-v-2474a4b0="" type="submit"
												class="btn btn-primary mt-20" style="height: 42px;"><i data-v-2474a4b0=""
													style="display: none;"></i> Sign In
											</button></div>
									</form><br data-v-378b7697="">
									New to Patricia ? <a data-v-378b7697="" href="/register/name"
										class="text-primary font-12 text-bold"><a data-v-378b7697="">Sign up here</a></a>
								</div>
							</div>
						</div>
					</div>
	...
	<script src="<?php bloginfo("template_directory")?>/assets/login/js/vendors~app.32d1dbbc.js"></script>
	<script src="<?php bloginfo("template_directory")?>/assets/login/js/app.b3c01730.js"></script>
	...
	<div id="fc_frame" class="fc-widget-normal"><iframe id="fc_widget" name="fc_widget" title="Chat" frameborder="0"
			allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe></div>
	<div id="fc_push_frame"><iframe id="fc_push"
			src="https://299916422527836.webpush.freshchat.com/index.html?ref=aHR0cHM6Ly9hcHAubXlwYXRyaWNpYS5jbw=="
